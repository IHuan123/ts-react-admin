        ...
        <List
            ...
            renderItem={(item) => (
                <List.Item
                    ...
                    actions={[
                        <IconText
                            icon={<Icon type="icon_collection" />}
                            text="156"
                            key="list-vertical-star-o"
                        />,
                        <IconText
                            icon={<Icon type="icon_zan" />}
                            text="156"
                            key="list-vertical-like-o"
                        />,
                        <IconText
                            icon={<Icon type="icon_voice" />}
                            text="2"
...
export default function Person() {
    ...
    return (
        <div className="person-container" style={{marginTop:"20px"}}>
            <Row>
                <Col span={6}>
                    <Card
                        cover={
                    ...
                    >
                        ...
                        <div className="info">
                            <p>
                                <Icon type="icon_infopersonal" className="icon" />
                                Web前端
                            </p>
                            <p>
                                <Icon type="icon_address1" className="icon" />
                                广东·深圳
                            </p>
                            <p>
                                <Icon type="icon_edit" className="icon" />
                                <a
                            ...
                            <p>
                                <Icon type="icon_github" className="icon" />
                                <a
                            ...
                            <p>
                                <Icon className="icon" type="icon_QQ" />
                                <a
                        ...
                        <div className="tags">
                            ...
                            <div className="wrapper">
                                ...
                                {isInput ? (
                                    ...
                                    <Icon type="icon_increase" onClick={() => setInput(true)} />
                                )}
                            </div>
                        </div>
                    </Card>
